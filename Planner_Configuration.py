...
def planner_process(AgentLocations, GoalLocations, safe_prob, DelaysProbDict, mapAndDim, verifyAlpha, gurobiModel, queue, typeOfVerify, countExpand):
    cbss = PlannerConfig(AgentLocations, GoalLocations, safe_prob, DelaysProbDict, mapAndDim, verifyAlpha, gurobiModel, queue, typeOfVerify, countExpand)
    cbss.run()

def run_planner_configuration_with_timeout(AgentLocations, GoalLocations, safe_prob, DelaysProbDict, mapAndDim,
